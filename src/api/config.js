...
export const TRAILER_MOVIE = "https://api.themoviedb.org/3/movie/:id/videos";
export const SEARCH_MOVIE = "https://api.themoviedb.org/3/search/movie?query=:query&page=1&";
